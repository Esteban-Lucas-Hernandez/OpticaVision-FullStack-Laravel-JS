        ...
        <div class="w-full max-w-5xl flex rounded-[2rem] shadow-2xl overflow-hidden bg-white transform transition-all duration-500 hover:shadow-[0_25px_50px_-12px_rgba(18,132,209,0.25)]">
            ...
            <div class="w-full lg:w-7/12 p-10 sm:p-14 md:p-16 flex flex-col justify-center bg-white relative">
                ...
                <div class="mb-10 text-center lg:text-left">
                    <h1 class="text-3xl sm:text-4xl font-extrabold text-[#173e67] mb-3">Crear Cuenta</h1>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Name -->
                    <div>
                        <label for="name" class="block text-sm font-bold text-[#173e67] mb-2 uppercase tracking-wide">Nombre Completo</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400 group-focus-within:text-[#1284d1] transition-colors" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label for="password_confirmation" class="block text-sm font-bold text-[#173e67] mb-2 uppercase tracking-wide">Confirmar</label>
                            <div class="relative group">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-[#1284d1] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                ...
                <div class="mt-12 text-center border-t border-gray-100 pt-8">
                    <p class="text-base text-gray-600">
                        ...
                        <a href="{{ route('login') }}" class="font-bold text-[#1284d1] hover:text-[#0a4d7a] transition-colors ml-1">
                            Inicia sesión aquí
                        </a>
                    </p>
                </div>
